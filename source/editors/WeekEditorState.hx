...
class WeekEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		txtWeekTitle.setFormat("Super Mario 256", 32, FlxColor.WHITE, RIGHT);
		...
		missingFileText.setFormat(Paths.font("SuperMario256.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		txtTracklist.font = Paths.font("SuperMario256.ttf");
